...
function gooi.newJoy(params)
 ...
 -- local circleRes = params.size
    --love.graphics.circle("fill", x-(circleRes*0),y-(circleRes*0),circleRes) 
  end
  ...
  function s:drawStick()
    ...
    if self.image then
      ...
      love.graphics.setColor(9.607,90.607,0.607,76.196)
      love.graphics.circle("fill", _x-(self.rStick*1),_y-(self.rStick*1),self.rStick*2)--,circleRes*2) 
