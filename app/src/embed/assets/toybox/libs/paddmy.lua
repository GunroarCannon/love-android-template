...
function Paddy:__init__(kwargs)
   ...
   --     self.joystick.y = love.graphics.getHeight()-20-self.joystick.h*3
    ...
    self.buttons.x = 20--love.graphics.getWidth()-20-self.buttons.w
    self.buttons.y = love.graphics.getHeight()-20-self.buttons.h
    ...
    for _ = 1,4 do
        ...
        for _,button in ipairs(widget.buttons) do
            if button.isDown then
                ...
                love.graphics.setColor(pr,pg,pb,0.784)
                ...
                local bw = self.buttonw-widget.padding*2
                local bh = self.buttonh-widget.padding*2
                local g = game:getAssetFromPath("toybox/utils/arrow.png")
